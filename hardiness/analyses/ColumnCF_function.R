...
adjustcf <- function(hitData,cd, ce, year, month, day, doynum){
...
#if the day of teh year is more than  303 (changeDate) and in teh "Acc" hardiness period then the value for 
#cf shoudl be 1
