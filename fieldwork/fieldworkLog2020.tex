...
\item This block goes almost right to the edge of the lake. 
...
\item 11.14 We went to Sav Banc block 4-6 and started upper 12 vines. 
...
\item A breake and then note writing. 
\end{smitemize}
...
\item Maybe contact Mr Mandheadrt 
