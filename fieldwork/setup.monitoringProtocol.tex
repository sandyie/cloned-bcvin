...
\item Use a pipette to add juice on the prism, covering the prism. %is it a specific amount? % In the past we have used plastic spoons, which we rinsed and wiped with Kimwipes between each use. 
