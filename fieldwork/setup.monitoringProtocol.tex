...
Package grapes in styrofoam freezer box and place in a cardboard box for shipping. \\ %With ice pack? % EMW: Yes!
...
\item Distilled water in a squeeze bottle for rinsing refractometer between samples % We do need distilled, we will have to BUY it or borrow it or such because we don't have it in the building. 
...
\item Set up and calibrate refractometer with DI water as a blank. Make sure temperature compensation is on and there are no bubbles. 
...
\item Transcribe sample-specific notes in the brix data tab and general notes in the 
\item Repeat. 
