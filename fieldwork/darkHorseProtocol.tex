...
\begin{figure}%this will always show at this point 
  ...
  \caption{A diagram of a cordon pruned vine, showing which spurs we would monitor and bud numbering. Any spur that's base was more than 5cm below the wire the cordon was trained on was not sampled.}
  \label{fig:CordonPruned}
\end{figure}

\begin{figure}%this will always show at this point 
  \includegraphics[width=\linewidth]{CanePruned.jpg}
  \caption{A diagram of a cane pruned vine, with the buds we would monitor and their numbering. Note that we do not sample buds too close to the head of the vine.}
