...
-> 2004 : formatted, needs vineyard value, col "sampler" (removed)
-> 2005 : formatted, needs vineyard value, col "dMACH" (removed)
-> 2006 : formatted, needs vineyard value, col "sampler" (removed)
-> 2007 : formatted, needs vineyard value, col "sampler" (removed)
-> 2008 : formatted, cols tag.no, sampler (removed)
		#year, month, day are three columns created from the column “crush.tag.date”
-> 2009 : formatted, needs vineyard value, col "sampler" (removed)
-> 2010 : formatted, needs vineyard value, col "sampler" (removed)
