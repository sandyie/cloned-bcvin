...
phen0012AllCh$Flowering [FloweringDateYear  %in% c("-NA", "NA-NA")] <- NA
phen0012AllCh$Flowering <- as.Date(phen0012AllCh$Flowering, format = "%Y-%B-%d" )#convert to as.date format
