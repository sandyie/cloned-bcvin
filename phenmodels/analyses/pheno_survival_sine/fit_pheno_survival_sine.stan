functions { 
  ...
  } // temp is f(x) name ... this takes in time, phase, etc. and gives you the value at any time you ask for it (note that for any thing in stan you have define it's time (hence 'real' before temp, and 'real' before time)
  ...
  // Wang-Engels Rescaled Temperature (we think Mike called this 'rescaled' since he rescaled the WE model)
